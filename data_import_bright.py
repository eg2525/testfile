...
# ユーザーからシート名を入力してもらう
desired_sheet_name = st.text_input("読み込むシート名を入力してください:")

if uploaded_files and desired_sheet_name:
    for uploaded_file in uploaded_files:
        # アップロードされたファイルからデータを読み込む
        df = pd.read_excel(uploaded_file, sheet_name=desired_sheet_name, header=7)
